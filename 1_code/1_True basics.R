...
# A variable allows you to store a value or an object in R for later use.
...
# Comments do not affect R's execution.
...
is.numeric(1L) #TRUE
is.integer(2) #FALSE
is.integer(2L) #TRUE, integers are numeric, but not all numerics are integers.
...
earnings * 3 #150 300 90
# Now find out your balance
expenses <- c(30, 40, 80)
banks <- earnings - expenses #20 60 -50
...
remain[c(FALSE, TRUE, FALSE, TRUE)] #the TRUE elements will be selected.
