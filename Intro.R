...
#Images references are in folder "images" and refered in comments with ()
...
plot(age, weight) #(Plot 1.1)
#Not surprisingly, as infants get older, they tend to weigh more.

#to see what R can do graphically
demo() #a complete list of demonstrations
#try out different types of demonstrations from the package "graphics"
demo(Hershey) 
demo(persp) 
demo(graphics)
demo(image) #(Plot 1.2-1.4_demo)

#getting help (Table 1.2)
help.start() #general help
help("function") #or ?"function" for specific function
help.search("function") #search the help system for instances of the function
example("function") #example of the function
RSiteSearch("function") #search online help manual
apropos("function", mode = "function") #list all avail functions containing the name
data() #list all available example datasets for currently installed packages

# or set current options
